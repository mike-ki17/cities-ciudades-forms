        ...
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                    ...
                    <ol class="flex items-center space-x-4">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-4 text-sm font-medium admin-text-secondary">Crear Evento</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <p class="mt-1 text-sm admin-text-secondary">
                    Crea un nuevo evento para una ciudad específica
                </p>
            </div>
        </div>
        ...
        <div class="mt-8">
            <form method="POST" action="{{ route('admin.events.store') }}" class="space-y-8">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-medium admin-text" id="preview-name">
                                    {{ old('name', 'Nombre del Evento') }}
                                </h3>
                                <p class="text-sm admin-text-secondary" id="preview-full-name">
                                    {{ old('name', 'Nombre del Evento') }} - {{ old('city', 'Ciudad') }}, {{ old('year', date('Y')) }}
                                </p>
                            </div>
                            <div class="flex-shrink-0">
                ...
                <div class="flex justify-end space-x-4 pt-6 border-t" style="border-color: var(--color-border);">
                    <a href="{{ route('admin.events.index') }}" class="admin-button-outline px-6 py-3 rounded-lg text-sm font-medium">
